...
public class ZkinfgerTmp extends JFrame{
	...
	public void launchFrame(){
      ...
      //For End
		...
		this.setTitle("SMC Fingerprint Registration");
...
//				String path = "d:\\test\\fingerprint.bmp";
				String path = "D:\\almostkbal\\projects\\SMC\\finger-scanner-app\\fingerprint.bmp";
				...
				if (0 == ret)
				{
					...
					if (0 == ret)
					{
                        ...
                        textArea.setText("enroll success");
...
//								ret = FingerprintSensorEx.DBMatch(mhDB, lastRegTemp, fpTemplate);
								...
								ret = FingerprintSensorEx.DBMatch(mhDB, smcService.getCitizenFingerTemplate(29106202101737l), fpTemplate);
								if(ret > 0)
								{
									textArea.setForeground(Color.GREEN);
								...
								textArea.setForeground(Color.RED);
								textArea.setText("Error occured while retreiving Citien fingerprint \n"+ e1.getMessage());
			...
			if(bRegister)
			{
                ...
                if (enroll_idx == 3) {
                    ...
                    if (0 == (ret = FingerprintSensorEx.DBMerge(mhDB, regtemparray[0], regtemparray[1], regtemparray[2], regTemp, _retLen)) &&
                        ...
                        try {
							smcService.createCitizenFingerTemplate(29106202101737l, regTemp);
							textArea.setForeground(Color.GREEN);
							textArea.setText("enroll success");
			...
			else
			{
				...
				else
				{
					...
					else
					{
						int ret;
						try {
							ret = FingerprintSensorEx.DBMatch(mhDB, smcService.getCitizenFingerTemplate(29106202101737l), template);
							if(ret > 0)
							{
								textArea.setForeground(Color.GREEN);
								textArea.setText("Verify success, score=" + ret);
